...
def cmd_args() -> dict:
    ...
    args.add_argument(
         ...
         '--input',
         dest='folder',
         help='Path to folder with participants ciftis'
    ...
    args.add_argument(
        ...
        dest="threshold",
        default=95
        help=f"Threshold value to retain values at",
    )
    args.add_argument(
        "-d",
        "--dim",
        dest="dim",
        help=f"Number of dimensions for the ICA",
    )
    args.add_argument(
        "-c",
        "--components",
        dest="components",
        default=2500,
        help=f"Number of components for the PCA",
    )
...
if __name__ == '__main__':
    ...
    save_gifti(left_ica, os.path.join(args['outdir'], "rsfmri_ica_decomp_left.func.gii"))
    save_gifti(right_ica, os.path.join(args['outdir'], "rsfmri_ica_decomp_right.func.gii"))